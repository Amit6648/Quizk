...
io.on('connection', (socket) => {
    ...
    socket.on('create-room', async ({ name, roomid }) => {
    ...
    socket.on('join-room', ({ name, roomid }) => {
        ...
        io.to(socket.roomid).emit('update-score', players);
    ...
    socket.on('start-game', async () => {
        ...
        const players = rooms[socket.roomid].players;
    ...
    socket.on('player-ans', async (answer) => {
        ...
        console.log(answer.current.option)
        console.log('this is the real answer', real.correctAnswer);

        if (answer.current.option === real.correctAnswer) {
